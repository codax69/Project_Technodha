...
const toast = (options) => {
  if (typeof toastManager.add === 'function') return toastManager.add(options)
  if (typeof toastManager.create === 'function') return toastManager.create(options)
  if (typeof toastManager === 'function') return toastManager(options)
}
